<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="bestIdeasCompetition.aspx.cs" Inherits="AppinnoNew.admin.bestIdeasCompetition" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="pages/bestIdeasCompetition/ajax.js"></script>
    <script src="pages/bestIdeasCompetition/js.js"></script>
    ...
    <title>درج مسابقه ایده برتر جدید</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a class="loc none" href="bestIdeasCompetition.aspx">درج مسابقه ایده برتر جدید</a>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="right-panel">
        ...
        <label class="label" for="fchk_forall">انتشار مسابقه برای همه</label>
        <div class="vertical_min"></div>

        <input class="check" type="radio" id="fchk_toGroup" name="2" />
        <label class="label" for="fchk_toGroup">انتشار مسابقه برای گروه های زیر:</label>
        <div class="vertical_small"></div>
