...
namespace AppinnoNew.admin
{
    public partial class cevent : System.Web.UI.Page
    {
        ...
        public static string getAllComment(string from, string to, string commentstate, string fillterString,string orderType, string sortby, int pageIndex)
        {
            ...
            var com = db.eventCommentTbls.AsQueryable();
            ...
            if (fillterString != "")
            {
                ...
                var predicate = PredicateBuilder.False<eventCommentTbl>();
            ...
            foreach (var item in acList)
            {
                ...
                tmp.newsID = item.eventID;
                tmp.text = item.text;
                tmp.newsTitle = item.eventsTbl.title;
        ...
        public static string blockComment(long commentID,bool isBlock)
        {
            ...
            if (db.eventCommentTbls.Any(c => c.ID == commentID) == false)
            {
                result.code = 3;
            ...
            var tmp = db.eventCommentTbls.Single(c => c.ID == commentID);
        ...
        public static string deleteComment(long commentID)
        {
            ...
            db.eventCommentTbls.DeleteOnSubmit(tmp);
            db.SubmitChanges();
        ...
        public static string deleteAllComment()
        {
            ...
            db.eventCommentTbls.DeleteAllOnSubmit(db.eventCommentTbls);
            db.SubmitChanges();
