...
{
    public partial class cican : System.Web.UI.Page
    {
        ...
        public static string getAllComment(string from, string to, string commentstate, string fillterString, string orderType, string sortby, int pageIndex)
        {
            ...
            var com = db.icanCommentTbls.AsQueryable();
            ...
            if (fillterString != "")
            {
                ...
                var predicate = PredicateBuilder.False<icanCommentTbl>();
            ...
            foreach (var item in acList)
            {
                ...
                tmp.newsID = item.icanID;
                tmp.text = item.text;
                tmp.newsTitle = item.icanTbl.title;
        ...
        public static string blockComment(long commentID, bool isBlock)
        {
            ...
            if (db.icanCommentTbls.Any(c => c.ID == commentID) == false)
            {
                result.code = 3;
            ...
            var tmp = db.icanCommentTbls.Single(c => c.ID == commentID);
        ...
        public static string deleteComment(long commentID)
        {
            ...
            db.icanCommentTbls.DeleteOnSubmit(tmp);
            db.SubmitChanges();
        ...
        public static string deleteAllComment()
        {
            ...
            db.icanCommentTbls.DeleteAllOnSubmit(db.icanCommentTbls);
            db.SubmitChanges();
