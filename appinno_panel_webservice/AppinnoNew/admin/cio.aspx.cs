...
{
    public partial class cio : System.Web.UI.Page
    {
        ...
        public static string getAllComment(string from, string to, string commentstate, string fillterString,string orderType, string sortby, int pageIndex)
        {
            ...
            var com = db.ioCommentTbls.AsQueryable();
            ...
            if (fillterString != "")
            {
                ...
                var predicate = PredicateBuilder.False<ioCommentTbl>();
            ...
            foreach (var item in acList)
            {
                ...
                tmp.newsID = item.ioID;
                tmp.text = item.text;
                tmp.newsTitle = item.ioTbl.title;
        ...
        public static string blockComment(long commentID,bool isBlock)
        {
            ...
            if (db.ioCommentTbls.Any(c => c.ID == commentID) == false)
            {
                result.code = 3;
            ...
            var tmp = db.ioCommentTbls.Single(c => c.ID == commentID);
        ...
        public static string deleteComment(long commentID)
        {
            ...
            db.ioCommentTbls.DeleteOnSubmit(tmp);
            db.SubmitChanges();
        ...
        public static string deleteAllComment()
        {
            ...
            db.ioCommentTbls.DeleteAllOnSubmit(db.ioCommentTbls);
            db.SubmitChanges();
