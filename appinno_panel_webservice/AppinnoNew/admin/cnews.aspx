<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="cnews.aspx.cs" Inherits="AppinnoNew.admin.cnews" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="pages/cnews/ajax.js"></script>
    <script src="pages/cnews/js.js"></script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="left-panel">
        <div class="group-list">
            <span class="header-group mci-1b"><span id="lt" > لیست نظرات </span><span id="total-count" style="display:inline-block"></span></span>
