...
{
    public partial class cnews : System.Web.UI.Page
    {
        ...
        public static string getAllComment(string from, string to, string commentstate, string fillterString,string orderType, string sortby, int pageIndex)
        {
            ...
            var com = db.newsCommentTbls.AsQueryable();
            ...
            if (fillterString != "")
            {
                ...
                var predicate = PredicateBuilder.False<newsCommentTbl>();
            ...
            foreach (var item in acList)
            {
                ...
                tmp.text = item.text;
                tmp.newsTitle = item.newsTbl.title;
        ...
        public static string blockComment(long commentID,bool isBlock)
        {
            ...
            if (db.newsCommentTbls.Any(c => c.ID == commentID) == false)
            {
                result.code = 3;
            ...
            var tmp = db.newsCommentTbls.Single(c => c.ID == commentID);
        ...
        public static string deleteComment(long commentID)
        {
            ...
            db.newsCommentTbls.DeleteOnSubmit(tmp);
            db.SubmitChanges();
        ...
        public static string deleteAllComment()
        {
            ...
            db.newsCommentTbls.DeleteAllOnSubmit(db.newsCommentTbls);
            db.SubmitChanges();
