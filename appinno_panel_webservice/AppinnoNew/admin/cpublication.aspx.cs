...
{
    public partial class cpublication : System.Web.UI.Page
    {
        ...
        public static string getAllComment(string from, string to, string commentstate, string fillterString,string orderType, string sortby, int pageIndex)
        {
            ...
            var com = db.publicationCommentTbls.AsQueryable();
            ...
            if (fillterString != "")
            {
                ...
                var predicate = PredicateBuilder.False<publicationCommentTbl>();
            ...
            foreach (var item in acList)
            {
                ...
                tmp.newsID = item.publicationID;
                tmp.text = item.text;
                tmp.newsTitle = item.publicationTbl.title;
        ...
        public static string blockComment(long commentID,bool isBlock)
        {
            ...
            if (db.publicationCommentTbls.Any(c => c.ID == commentID) == false)
            {
                result.code = 3;
            ...
            var tmp = db.publicationCommentTbls.Single(c => c.ID == commentID);
        ...
        public static string deleteComment(long commentID)
        {
            ...
            db.publicationCommentTbls.DeleteOnSubmit(tmp);
            db.SubmitChanges();
        ...
        public static string deleteAllComment()
        {
            ...
            db.publicationCommentTbls.DeleteAllOnSubmit(db.publicationCommentTbls);
            db.SubmitChanges();
