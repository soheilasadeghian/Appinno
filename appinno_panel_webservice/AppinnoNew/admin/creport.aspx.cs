...
namespace AppinnoNew.admin
{
    public partial class creport : System.Web.UI.Page
    {
        ...
        public static string getAllComment(string from, string to, string commentstate, string fillterString,string orderType, string sortby, int pageIndex)
        {
            ...
            var com = db.reportCommentTbls.AsQueryable();
            ...
            if (fillterString != "")
            {
                ...
                var predicate = PredicateBuilder.False<reportCommentTbl>();
            ...
            foreach (var item in acList)
            {
                ...
                tmp.newsID = item.reportID;
                tmp.text = item.text;
                tmp.newsTitle = item.masterReportTbl.title;
        ...
        public static string blockComment(long commentID,bool isBlock)
        {
            ...
            if (db.reportCommentTbls.Any(c => c.ID == commentID) == false)
            {
                result.code = 3;
            ...
            var tmp = db.reportCommentTbls.Single(c => c.ID == commentID);
        ...
        public static string deleteComment(long commentID)
        {
            ...
            db.reportCommentTbls.DeleteOnSubmit(tmp);
            db.SubmitChanges();
        ...
        public static string deleteAllComment()
        {
            ...
            db.reportCommentTbls.DeleteAllOnSubmit(db.reportCommentTbls);
            db.SubmitChanges();
