<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="download.aspx.cs" Inherits="AppinnoNew.admin.download" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="pages/download/css.css" rel="stylesheet" />
    ...
    <script src="pages/download/ajax.js"></script>
    <script src="pages/download/js.js"></script>
