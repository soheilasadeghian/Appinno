<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="emyIran.aspx.cs" Inherits="AppinnoNew.admin.emyIran" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="pages/emyIran/ajax.js"></script>
    <script src="pages/emyIran/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a class="loc none" href="myIranlist.aspx">لیست مسابقات ایران من</a>
    <a class="spacer">></a>
    <a class="loc none">ویرایش مسابقه ایران من</a>
</asp:Content>
