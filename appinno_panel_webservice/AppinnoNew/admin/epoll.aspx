<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="epoll.aspx.cs" Inherits="AppinnoNew.admin.epoll" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="pages/epoll/css.css" rel="stylesheet" />
    ...
    <script src="pages/epoll/ajax.js"></script>
    <script src="pages/epoll/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a href="polllist.aspx" class="loc history">لیست نظرسنجی ها</a>
    <a class="spacer">></a>
    <a class="loc none">ویرایش نظرسنجی</a>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    <div class="vertical_min"></div>
    <div class="right-panel">
        <span class="header-news-panel  mci-1b">محتوای نظرسنجی</span>
        <div class="vertical_min"></div>
        <div class="field">
            <span class="span">تاریخ انتشار از</span>
            <input id="date1" type="text" name="news-pubdate" value="" placeholder="تاریخ انتشار از" maxlength="10" />
            <img class="hint" src="component/images/info.png" alt="راهنما" title="نظرسنجی از این تاریخ به بعد نمایش داده خواهد شد" data-tipped-options="position: 'left'" />
        </div>
        <div class="vertical_small"></div>
        <div class="field">
            <span class="span">تاریخ انتشار تا</span>
            <input id="date2" type="text" name="news-pubdate" value="" placeholder="تاریخ انتشار تا" maxlength="10" />
            <img class="hint" src="component/images/info.png" alt="راهنما" title="نظرسنجی تا این تاریخ نمایش داده میشود" data-tipped-options="position: 'left'" />
        </div>
        <div class="vertical_small"></div>
        <div class="field">
            <span class="span">تگ</span>
            <input id="tagstring" type="text" name="news-pubdate" value="" placeholder="تگ ها"  />
            <img class="hint" src="component/images/info.png" alt="راهنما" title="درصورت تمایل می توانید برای نظرسنجی مورد نظر تگ وارد نمایید.مثال:#همراه اول #اپی نو" data-tipped-options="position: 'left'" />
        </div>
        <div class="vertical_min"></div>
        <hr />
        <div class="vertical_min"></div>
        <div class="tools">
            <a class="button image" title="این دکمه جهت درج تصویر به محتوای نظرسنجی  می باشد" data-tipped-options="position: 'top'" onclick="$('#file_image').click();"></a>
            <input class="file_image" type="file" style="display: none" id="file_image" />

            <a id="add-para" class="button text" title="این دکمه جهت درج متن به محتوای نظرسنجی  می باشد" data-tipped-options="position: 'top'"></a>
        </div>
        <div class="vertical_min"></div>
        <hr />
        <div class="field-option-new">
            <div class="option-panel">
                <div id="op-tool">
                <span class="label span">گزینه جدید</span>
                <input id="new-option-input" class="new-option-input" type="text" name="newOption" value="" placeholder="گزینه جدید" />
                <input id="btn-add-option" type="button" class="add-option" value="+" />
                    </div>
                <div class="vertical_min"></div>

                <div id="option-list" >
<%--                    <div class="op-item">
                        <input type="text" class="option-record" name="name" value="آیا مایل هستید؟" />
        ...
        <label class="label" for="fchk_forall">انتشار نظرسنجی برای همه</label>
        <div class="vertical_min"></div>

        <input class="check" type="radio" id="fchk_toGroup" name="2" />
        <label class="label" for="fchk_toGroup">انتشار نظرسنجی برای گروه های زیر:</label>
        <div class="vertical_small"></div>
        ...
        <label class="label" for="fchk_block">نظرسنجی مسدود شود</label>
        <hr />
   ...
   <div class="clear"></div>
    ...
    <div id="upload-news-window" class="upload-news-window">
        <div class="background"></div>
        <div class="window">
            <div class="window-header mci-1b"><span>درحال ذخیره سازی نظرسنجی ...</span></div>
            <div class="vertical_min"></div>
            <div class="upload">
                <div class="clear"></div>
