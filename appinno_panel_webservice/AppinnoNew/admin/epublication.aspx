<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="epublication.aspx.cs" Inherits="AppinnoNew.admin.epublication" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="pages/epublication/css.css" rel="stylesheet" />
    ...
    <script src="pages/epublication/ajax.js"></script>
    <script src="pages/epublication/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a href="publicationlist.aspx" class="loc history">لیست انتشارات</a>
    <a class="spacer">></a>
    <a class="loc none">ویرایش انتشارات</a>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="right-panel">
        ...
        <div class="field">
            ...
            <input id="main-title" type="text" name="news-title" value="" placeholder="نام انتشارت" maxlength="250" />
        ...
        <label class="label" for="fchk_block">انتشارات مسدود شود</label>
        <hr />
