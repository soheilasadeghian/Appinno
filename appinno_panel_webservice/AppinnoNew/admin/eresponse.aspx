<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="eresponse.aspx.cs" Inherits="AppinnoNew.admin.eresponse" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="pages/eresponse/ajax.js"></script>
    <script src="pages/eresponse/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a class="loc none" href="myIranlist.aspx">مسابقات ایران من</a>
    <a class="spacer">></a>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="right-panel">
        ...
        <div class="field">
            ...
            <input id="main-title" type="text" name="response-title" value="" placeholder="عنوان اصلی پاسخ" maxlength="250" readonly />
