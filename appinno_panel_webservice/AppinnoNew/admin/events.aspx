<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="events.aspx.cs" Inherits="AppinnoNew.admin.events" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="pages/events/css.css" rel="stylesheet" />
    ...
    <script src="pages/events/ajax.js"></script>
    <script src="pages/events/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a class="loc none">درج رویداد جدید</a>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="right-panel">
        ...
        <div class="field">
            ...
            <input id="main-title" type="text" name="news-title" value="" placeholder="عنوان اصلی رویداد" maxlength="250" />
            <img class="hint" src="component/images/info.png" alt="راهنما" title="- عنوان اصلی رویداد که در لیست رویدادها نرم افزار نمایش داده خواهد شد.<br/>- طول این پارامتر حداکثر 250 کاراکتر میباشد." data-tipped-options="position: 'left'" />
        </div>
