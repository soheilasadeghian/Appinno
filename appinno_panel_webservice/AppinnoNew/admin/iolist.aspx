<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="iolist.aspx.cs" Inherits="AppinnoNew.admin.iolist" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="pages/iolist/css.css" rel="stylesheet" />
    ...
    <script src="pages/iolist/ajax.js"></script>
    <script src="pages/iolist/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a class="loc none">لیست سازمان ها</a>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="right-panel">
        <div class="search-box">
            ...
            <label for="chk_date">تاریخ درج سازمان از : </label>
            ...
            <label for="chk_dateto">تاریخ درج سازمان تا : </label>
            <div class="vertical_small"></div>
            ...
            <hr />
            <div class="vertical_small"></div>
            <input id="fillter-input" type="text" class="search-input" placeholder="جستجو در سازمان ها..." value="" />
            <div class="vertical_small"></div>
            <hr />

            <div class="vertical_small"></div>
            <input class="check" type="radio" id="fchk_nogrp" checked="checked" name="2" />
            <label for="fchk_nogrp">سازمان های عمومی</label>
            <div class="vertical_min"></div>

            <input class="check" type="radio" id="fchk_allitem" name="2" />
            <label for="fchk_allitem">همه سازمان های گروه بندی شده</label>
            <div class="vertical_min"></div>

            <input class="check" type="radio" id="fchk_toGroup" name="2" />
            <label for="fchk_toGroup">سازمان های قرارگرفته در گروه زیر:</label>
            <div class="vertical_small"></div>
    ...
    <div class="left-panel">
        <div class="group-list">
            <span class="header-group mci-1b"><span id="lt">لیست سازمان های عمومی</span> <span id="total-count"></span></span>
            <a id="deleteall-btn" class="delete-all" title="حذف همه ی سازمان ها"></a>
            <div class="clear"></div>
