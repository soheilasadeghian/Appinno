<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="newslist.aspx.cs" Inherits="AppinnoNew.admin.newslist" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="pages/newslist/ajax.js"></script>
    <script src="pages/newslist/js.js"></script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="right-panel">
        <div class="search-box">
            ...
            <label for="chk_date">تاریخ درج خبر از : </label>
            ...
            <label for="chk_dateto">تاریخ درج خبر تا : </label>
            <div class="vertical_small"></div>
            ...
            <hr />
            <div class="vertical_small"></div>
            <input id="fillter-input" type="text" class="search-input" placeholder="جستجو در اخبار..." value="" />
            <div class="vertical_small"></div>
            <hr />

            <div class="vertical_small"></div>
            <input class="check" type="radio" id="fchk_nogrp" checked="checked" name="2" />
            <label for="fchk_nogrp">اخبار عمومی</label>
            <div class="vertical_min"></div>

            <input class="check" type="radio" id="fchk_allitem" name="2" />
            <label for="fchk_allitem">همه اخبار گروه بندی شده</label>
            <div class="vertical_min"></div>

            <input class="check" type="radio" id="fchk_toGroup" name="2" />
            <label for="fchk_toGroup">اخبار قرارگرفته در گروه زیر:</label>
            <div class="vertical_small"></div>
    ...
    <div class="left-panel">
        <div class="group-list">
            <span class="header-group mci-1b"><span id="lt" >لیست اخبار عمومی</span> <span id="total-count" style="display:inline-block"></span></span>
