...
function setup_save_all() {
    $("#btn-save-all").click(function () {
        ...
        form.append("myIranID", currentItem.ID);
        ...
        $("#bar").on("onFinished", function (event, result) {
            ...
            try {
                if (result.code == 0) {
                    ...
                    setTimeout(function () { window.location.href = "myIranlist.aspx"; }, 1500);
                }
                else {
