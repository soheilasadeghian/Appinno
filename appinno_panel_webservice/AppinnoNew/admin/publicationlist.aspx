<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="publicationlist.aspx.cs" Inherits="AppinnoNew.admin.publicationlist" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="pages/publicationlist/css.css" rel="stylesheet" />
    ...
    <script src="pages/publicationlist/ajax.js"></script>
    <script src="pages/publicationlist/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a class="loc none">لیست انتشارات</a>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="right-panel">
        <div class="search-box">
            ...
            <label for="chk_date">تاریخ درج انتشارات از : </label>
            ...
            <label for="chk_dateto">تاریخ درج انتشارات تا : </label>
            <div class="vertical_small"></div>
            ...
            <hr />
            <div class="vertical_small"></div>
            <input id="fillter-input" type="text" class="search-input" placeholder="جستجو در انتشارات..." value="" />
            <div class="vertical_small"></div>
            <hr />

            <div class="vertical_small"></div>
            <input class="check" type="radio" id="fchk_nogrp" checked="checked" name="2" />
            <label for="fchk_nogrp">انتشارات عمومی</label>
            <div class="vertical_min"></div>

            <input class="check" type="radio" id="fchk_allitem" name="2" />
            <label for="fchk_allitem">همه انتشارات گروه بندی شده</label>
            <div class="vertical_min"></div>

            <input class="check" type="radio" id="fchk_toGroup" name="2" />
            <label for="fchk_toGroup">انتشارات قرارگرفته در گروه زیر:</label>
            <div class="vertical_small"></div>
    ...
    <div class="left-panel">
        <div class="group-list">
            <span  class="header-group mci-1b"><span id="lt">لیست انتشارات عمومی</span> <span id="total-count"></span></span>
            <a id="deleteall-btn" class="delete-all" title="حذف همه ی انتشارات"></a>
            <div class="clear"></div>
