<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="report.aspx.cs" Inherits="AppinnoNew.admin.report" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="pages/report/css.css" rel="stylesheet" />
    ...
    <script src="pages/report/ajax.js"></script>
    <script src="pages/report/js.js"></script>
    ...
    <title>درج نمودار جدید</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    <a href="dashboard.aspx" class="loc history">داشبورد</a>
    <a class="spacer">></a>
    <a class="loc none">نمودار</a>
    <a class="spacer">></a>
    <a class="loc none">درج نمودار جدید</a>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="right-panel">
        ...
        <div class="vertical_min"></div>
        <div class="tools">
            <a class="button image" title="این دکمه جهت درج تصویر نمودار  می باشد" data-tipped-options="position: 'top'" onclick="$('#file_image').click();"></a>
