<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="responselist.aspx.cs" Inherits="AppinnoNew.admin.responselist" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="pages/responselist/ajax.js"></script>
    <script src="pages/responselist/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a class="loc none">لیست پاسخ های های مسابقه ایران من</a>
    <a class="spacerer">:</a>
