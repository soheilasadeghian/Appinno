<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="cdownload.aspx.cs" Inherits="AppinnoNew.admin.cdownload" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="pages/cdownload/ajax.js"></script>
    <script src="pages/cdownload/js.js"></script>
    ...
    <a href="cdownload.aspx">cdownload.aspx</a>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="left-panel">
        <div class="group-list">
            <span id="lt" class="header-group mci-1b">لیست نظرات</span>
