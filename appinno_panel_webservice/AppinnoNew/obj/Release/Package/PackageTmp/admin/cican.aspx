<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="cican.aspx.cs" Inherits="AppinnoNew.admin.cican" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="pages/cican/ajax.js"></script>
    <script src="pages/cican/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a class="loc none">من می توانم</a>
    <a class="spacer">></a>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="right-panel">
        <div class="search-box">
            ...
            <label class="inner-caption">نمایش نظرات : </label>
            <div class="vertical_small"></div>
            <div class="combo">
