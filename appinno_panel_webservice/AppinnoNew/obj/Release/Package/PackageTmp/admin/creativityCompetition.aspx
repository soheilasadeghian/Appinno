<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="creativityCompetition.aspx.cs" Inherits="AppinnoNew.admin.creativityCompetition" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="pages/creativityCompetition/ajax.js"></script>
    <script src="pages/creativityCompetition/js.js"></script>
    ...
    <title>درج مسابقه خلاقیت جدید</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a class="loc none" href="creativityCompetition.aspx">درج مسابقه خلاقیت جدید</a>
</asp:Content>
