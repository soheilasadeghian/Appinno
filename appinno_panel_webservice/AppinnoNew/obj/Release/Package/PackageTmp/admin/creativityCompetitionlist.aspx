<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="creativityCompetitionlist.aspx.cs" Inherits="AppinnoNew.admin.creativityCompetitionlist" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="pages/creativityCompetitionlist/ajax.js"></script>
    <script src="pages/creativityCompetitionlist/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="loc none" href="creativityCompetition.aspx" style="float: left;background-color: #b0b0b0;color: #0c3a4a;">درج مسابقه  جدید</a>
</asp:Content>
        ...
        <div class="search-box">
            ...
            <div class="combo">
                <div id="itemstatus" class=" select">
                    ...
                    <span class="option" value="درحال برگزاری">درحال برگزاری</span>
                    <span class="option" value="درحال بررسی نتایج">درحال بررسی نتایج</span>
        ...
        <div class="group-list">
            ...
            <div class="insert">
                ...
                <div style="float: left;">
                    <a class="loc none" href="creativityCompetition.aspx" style="float: left;background-color: #b0b0b0;color: #0c3a4a;padding: 10px;text-decoration: none;font-size: 0.8em;">درج مسابقه  جدید</a>
                </div>
            </div>
        </div>
    </div>
