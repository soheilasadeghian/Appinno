<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="ebestIdeasCompetition.aspx.cs" Inherits="AppinnoNew.admin.ebestIdeasCompetition" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="pages/ebestIdeasCompetition/ajax.js"></script>
    <script src="pages/ebestIdeasCompetition/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a class="loc none">ویرایش مسابقه ایده برتر</a>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="right-panel">
        ...
        <div class="field">
            ...
            <input id="main-title" type="text" name="bestIdeasCompetition-title" value="" placeholder="عنوان اصلی مسابقه" maxlength="250" />
        ...
        <div class="field">
            ...
            <input id="startDate" type="text" name="bestIdeasCompetition-startDate" value="" placeholder="تاریخ شروع مسابقه" maxlength="10" />
            <img class="hint" src="component/images/info.png" alt="راهنما" title="مسابقه درج شده از این تاریخ به بعد در نرم افزار نمایش داده می شود و کاربران می توانند ایده های خود را از این تارین ثبت نمایند." data-tipped-options="position: 'left'" />
        </div>
        <div class="vertical_small"></div>
        <div class="field">
            <span class="span">تاریخ پایان مسابقه</span>
            <input id="endDate" type="text" name="bestIdeasCompetition-endDate" value="" placeholder="تاریخ پایان مسابقه" maxlength="10" />
            <img class="hint" src="component/images/info.png" alt="راهنما" title="مسابقه درج شده تا این تاریخ در نرم افزار نمایش داده می شود و کاربران می توانند ایده های خود را تا این تارین ثبت نمایند .از این تاریخ رأی گیری به ایده ها آغاز می شود." data-tipped-options="position: 'left'" />
        </div>
        <div class="vertical_small"></div>
        <div class="field">
        ...
        <div class="vertical_small"></div>
        <div class="field">
            <span class="span">تاریخ اعلام نتایج مسابقه</span>
            <input id="resultVoteDate" type="text" name="bestIdeasCompetition-resultVoteDate" value="" placeholder="تاریخ اعلام نتایج مسابقه" maxlength="10" />
            <img class="hint" src="component/images/info.png" alt="راهنما" title="رأی گیری مسابقه تا این تاریخ در نرم افزار ادامه داردو در این تاریخ نتایج مسابقه اعلام خواهد شد" data-tipped-options="position: 'left'" />
        </div>
        <div class="vertical_min"></div>
         <div id="divnotificationText" style="display:none;" class="field">
            <span class="span">پیام شروع مسابقه</span>
            <input  type="text" id="notificationText" value="" placeholder="پیام اطلاع رسانی شروع مسابقه" maxlength="200" readonly />
            <img class="hint" src="component/images/info.png" alt="راهنما" title="متن پیام اطلاع رسانی شروع مسابقه" data-tipped-options="position: 'left'" />
        </div>
        <div class="vertical_min"></div>
        <hr />
        <div class="tools">
        ...
        <label class="label" for="fchk_block">مسابقه مسدود شود</label>
        <hr />
