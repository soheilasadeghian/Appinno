<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="ecreativityCompetition.aspx.cs" Inherits="AppinnoNew.admin.ecreativityCompetition" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="pages/ecreativityCompetition/ajax.js"></script>
    <script src="pages/ecreativityCompetition/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a class="loc none">ویرایش مسابقه خلاقیت</a>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="right-panel">
        ...
        <div class="field">
            ...
            <input id="main-title" type="text" name="creativityCompetition-title" value="" placeholder="عنوان اصلی مسابقه" maxlength="250" />
        ...
        <div class="field">
            ...
            <input id="startDate" type="text" name="creativityCompetition-startDate" value="" placeholder="تاریخ شروع مسابقه" maxlength="10" />
        ...
        <div class="field">
            ...
            <input id="endDate" type="text" name="creativityCompetition-endDate" value="" placeholder="تاریخ پایان مسابقه" maxlength="10" />
            <img class="hint" src="component/images/info.png" alt="راهنما" title="مسابقه درج شده تا این تاریخ در نرم افزار نمایش داده می شود و کاربران می توانند پاسخ های خود را تا این تارین ثبت نمایند .از این تاریخ بررسی پاسخ های مسابقه آغاز می شود." data-tipped-options="position: 'left'" />
        </div>
        <div class="vertical_small"></div>
        <div class="field">
