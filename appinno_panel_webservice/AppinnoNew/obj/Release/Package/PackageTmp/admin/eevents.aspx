<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="eevents.aspx.cs" Inherits="AppinnoNew.admin.eevents" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="pages/eevents/css.css" rel="stylesheet" />
    ...
    <script src="pages/eevents/ajax.js"></script>
    <script src="pages/eevents/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a href="eventslist.aspx" class="loc history">لیست رویدادها</a>
    <a class="spacer">></a>
    <a class="loc none">ویرایش رویداد</a>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    <div class="vertical_min"></div>
    <div class="right-panel">
        <span class="header-news-panel  mci-1b">محتوای رویداد</span>
        <div class="vertical_min"></div>
        <div class="field">
            <span class="span">عنوان رویداد</span>
            <input id="main-title" type="text" name="news-title" value="" placeholder="عنوان رویداد" maxlength="250" />
            <img class="hint" src="component/images/info.png" alt="راهنما" title="- عنوان رویداد که در لیست رویدادها نرم افزار نمایش داده خواهد شد.<br/>- طول این پارامتر حداکثر 250 کاراکتر میباشد." data-tipped-options="position: 'left'" />
        </div>
        <div class="vertical_small"></div>
        <div class="field">
            <span class="span">تاریخ شروع</span>
            <input id="date1" type="text" name="news-pubdate" value="" placeholder="تاریخ شروع" maxlength="10" />
            <img class="hint" src="component/images/info.png" alt="راهنما" title="رویداد درج شده از این تاریخ به بعد در نرم افزار نمایش داده می شود" data-tipped-options="position: 'left'" />
        </div>
        <div class="vertical_small"></div>
        <div class="field">
            <span class="span">تاریخ پایان</span>
            <input id="date2" type="text" name="news-pubdate" value="" placeholder="تاریخ پایان" maxlength="10" />
            <img class="hint" src="component/images/info.png" alt="راهنما" title="رویداد درج شده از این تاریخ به بعد در نرم افزار نمایش داده نمی شود" data-tipped-options="position: 'left'" />
        </div>
         <div class="vertical_small"></div>
        <div class="field">
            <span class="span">تگ</span>
            <input id="tagstring" type="text" name="news-pubdate" value="" placeholder="تگ ها"  />
            <img class="hint" src="component/images/info.png" alt="راهنما" title="درصورت تمایل می توانید برای رویداد مورد نظر تگ وارد نمایید.مثال:#همراه اول #اپی نو" data-tipped-options="position: 'left'" />
        </div>
        <div class="vertical_min"></div>
        <hr />
        <div class="vertical_min"></div>
        <div class="tools">
            <a class="button image" title="این دکمه جهت درج تصویر به محتوای رویداد می باشد" data-tipped-options="position: 'top'" onclick="$('#file_image').click();"></a>
            <input class="file_image" type="file" style="display: none" id="file_image" />

            <a class="button video" title="این دکمه جهت درج ویدئو به محتوای رویداد می باشد<br />پسوند قابل قبول ویدیو mp4 می باشد." data-tipped-options="position: 'top'" onclick="$('#file_video').click();"></a>
            <input class="file_video" type="file" style="display: none" id="file_video" />

            <a id="add-para" class="button text" title="این دکمه جهت درج متن به محتوای رویداد می باشد" data-tipped-options="position: 'top'"></a>
        </div>
        <div class="vertical_min"></div>
         <hr />
        ...
        <label class="label" for="fchk_forall">انتشار رویداد برای همه</label>
        <div class="vertical_min"></div>

        <input class="check" type="radio" id="fchk_toGroup" name="2" />
        <label class="label" for="fchk_toGroup">انتشار رویداد برای گروه های زیر:</label>
        <div class="vertical_small"></div>
        ...
        <label class="label" for="fchk_block">رویداد مسدود شود</label>
        <hr />
    ...
    <div id="upload-news-window" class="upload-news-window">
        <div class="background"></div>
        <div class="window">
            <div class="window-header mci-1b"><span>درحال ذخیره سازی رویداد...</span></div>
            <div class="vertical_min"></div>
            <div class="upload">
                <div class="clear"></div>
