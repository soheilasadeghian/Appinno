<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="ereport.aspx.cs" Inherits="AppinnoNew.admin.ereport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="pages/ereport/css.css" rel="stylesheet" />
    ...
    <script src="pages/ereport/ajax.js"></script>
    <script src="pages/ereport/js.js"></script>
    ...
    <title>ویرایش نمودار</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    <a href="dashboard.aspx" class="loc history">داشبورد</a>
    <a class="spacer">></a>
    <a class="loc none">نمودارها</a>
    <a class="spacer">></a>
    <a href="reportlist.aspx" class="loc history">لیست نمودارها</a>
    <a class="spacer">></a>
    <a class="loc none">ویرایش نمودار</a>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    <div class="vertical_min"></div>
    <div class="right-panel">
        <span class="header-news-panel  mci-1b">محتوای نمودار</span>
        <div class="vertical_min"></div>
        <div class="field">
            <span class="span">عنوان اصلی نمودار</span>
            <input id="main-title" type="text" name="news-title" value="" placeholder="عنوان اصلی نمودار" maxlength="250" />
            <img class="hint" src="component/images/info.png" alt="راهنما" title="- عنوان اصلی نمودار که در لیست نمودارها نرم افزار نمایش داده خواهد شد.<br/>- طول این پارامتر حداکثر 250 کاراکتر میباشد." data-tipped-options="position: 'left'" />
        </div>
        ...
        <div class="field">
            ...
            <img class="hint" src="component/images/info.png" alt="راهنما" title="نمودار درج شده از این تاریخ به بعد در نرم افزار نمایش داده می شود" data-tipped-options="position: 'left'" />
        </div>
        <div class="vertical_small"></div>
        <div class="field">
            <span class="span">تگ</span>
            <input id="tagstring" type="text" name="news-pubdate" value="" placeholder="تگ ها"  />
            <img class="hint" src="component/images/info.png" alt="راهنما" title="درصورت تمایل می توانید برای گزارش مورد نظر تگ وارد نمایید.مثال:#همراه اول #اپی نو" data-tipped-options="position: 'left'" />
        </div>
        <div class="vertical_min"></div>
        <hr />
        <div class="vertical_min"></div>
        <div class="tools">
            <a class="button image" title="این دکمه جهت درج تصویر به محتوای نمودار می باشد" data-tipped-options="position: 'top'" onclick="$('#file_image').click();"></a>
            <input class="file_image" type="file" style="display: none" id="file_image" />

            <a id="file_chart" class="button video" title="این دکمه جهت درج نمودار به محتوای نمودار می باشد." data-tipped-options="position: 'top'"></a>

            <a id="add-para" class="button text" title="این دکمه جهت درج متن به محتوای نمودار می باشد" data-tipped-options="position: 'top'"></a>
        </div>
        <div class="vertical_min"></div>
         <hr />
        ...
        <label class="label" for="fchk_forall">انتشار نمودار برای همه</label>
        <div class="vertical_min"></div>

        <input class="check" type="radio" id="fchk_toGroup" name="2" />
        <label class="label" for="fchk_toGroup">انتشار نمودار برای گروه های زیر:</label>
        <div class="vertical_small"></div>
        ...
        <label class="label" for="fchk_block">نمودار مسدود شود</label>
        <hr />
   ...
   <div id="upload-news-window" class="upload-news-window">
        <div class="background"></div>
        <div class="window">
            <div class="window-header mci-1b"><span id="uploading-title">درحال ذخیره سازی نمودار...</span></div>
            <div class="vertical_min"></div>
            <div class="upload">
                <div class="clear"></div>
    ...
    <div id="new-chart-window" class="new-chart-window">
        <div class="background"></div>
        <div class="window">
            <div class="window-header mci-1b"><span>درج نمودار جدید</span></div>
            <div class="vertical_min"></div>
            <div class="para-title"><span>محور افقی</span><input id="input-xtitle-chart-window" type="text" value="" placeholder="محور افقی" /></div>
           
            <div class="para-title"><span>محور عمودی</span><input id="input-ytitle-chart-window" type="text" value="" placeholder="محور عمودی" /></div>
            <div class="vertical_min"></div>
            <div class="bartype">
                <input type="radio" name="5" id="rdo-bar" checked="checked" />
                <label for="rdo-bar">میله ای</label>
                <input type="radio" name="5" id="rdo-pie" />
                <label for="rdo-pie">دایره</label>
                <input type="radio" name="5" id="rdo-line" />
                <label for="rdo-line">خطی</label>
            </div>
            <hr />
            ...
            <hr />
            <input type="file" class="file-x" style="display: none" id="file-x" />
            <input id="btn-save-insert-chart-window" title="ذخیره سازی موقت اطلاعات و بستن پنجره" type="button" class="save" value="✔" data-tipped-options="position: 'bottom'" />
            <input id="btn-upload-chart" type="button" class="upload" data-tipped-options="position: 'bottom'" title="آپلود فایل excel نمودار" />
            <input id="btn-close-insert-chart-window" title="انصراف و بستن پنجره" type="button" class="save" style="font-weight:bolder;font-size:23px" value="ˣ" data-tipped-options="position: 'bottom'" />
        </div>
    </div>
</asp:Content>
