<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="ican.aspx.cs" Inherits="AppinnoNew.admin.ican" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="pages/ican/ajax.js"></script>
    <script src="pages/ican/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a class="loc none">درج توانایی جدید</a>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="right-panel">
        ...
        <div class="vertical_min"></div>
        <div class="field">
            <span class="span">عنوان اصلی توانایی</span>
