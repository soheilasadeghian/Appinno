<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="idealist.aspx.cs" Inherits="AppinnoNew.admin.idealist" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="pages/idealist/ajax.js"></script>
    <script src="pages/idealist/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a class="loc none" >لیست ایده های مسابقه ایده برتر</a>
    <a class="spacerer">:</a>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="right-panel">
        <div class="search-box">
            ...
            <div id="other-p">
                ...
                <hr />
                <div class="vertical_small"></div>
                <input id="fillter-input" type="text" class="search-input" placeholder="جستجو در ایده ها..." value="" />
                <div class="vertical_small"></div>
                <hr />
    ...
    <div class="left-panel">
        <div class="group-list">
            <span id="lt" class="header-group mci-1b">لیست ایده ها</span>
            <%--<a id="deleteall-btn" class="delete-all" title="حذف همه ی ایده ها"></a>--%>
            <div class="clear"></div>
