var emyIran = {
    ...
    urls: [
            "/admin/myIranUploader.ashx?mode=e",
            "emyIran.aspx/getAllGroup",
            "emyIran.aspx/getAllSubGroup",
            "emyIran.aspx/getmyIran",
            "emyIran.aspx/getAllTag"
    ],
    ...
    f4: function (myIranID) {
        var result;
        $.ajax({
            type: "POST",
            url: emyIran.urls[3],
            data: '{myIranID:"' + myIranID + '" }',
            contentType: "application/json; charset=utf-8",
            dataType: "json", async: false,
            success: function (response) {
