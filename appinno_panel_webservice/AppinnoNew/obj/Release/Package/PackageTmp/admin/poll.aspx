<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="poll.aspx.cs" Inherits="AppinnoNew.admin.poll" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="pages/poll/css.css" rel="stylesheet" />
    ...
    <script src="pages/poll/ajax.js"></script>
    <script src="pages/poll/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a class="loc none">درج نظرسنجی  جدید</a>
</asp:Content>
