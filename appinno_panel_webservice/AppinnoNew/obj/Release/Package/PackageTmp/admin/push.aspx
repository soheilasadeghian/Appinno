<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="push.aspx.cs" Inherits="AppinnoNew.admin.push" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="pages/push/css.css" rel="stylesheet" />
    ...
    <script src="pages/push/ajax.js"></script>
    <script src="pages/push/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a class="loc none">ارسال پیام مدیر</a>
</asp:Content>
