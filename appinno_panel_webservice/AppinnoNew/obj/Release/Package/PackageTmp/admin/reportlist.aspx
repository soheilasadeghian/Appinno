<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master.Master" AutoEventWireup="true" CodeBehind="reportlist.aspx.cs" Inherits="AppinnoNew.admin.reportlist" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="pages/reportlist/css.css" rel="stylesheet" />
    ...
    <script src="pages/reportlist/ajax.js"></script>
    <script src="pages/reportlist/js.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="path" runat="server">
    ...
    <a class="spacer">></a>
    <a class="loc none">لیست نمودارها</a>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="right-panel">
        <div class="search-box">
            ...
            <label for="chk_date">تاریخ درج نمودار از : </label>
            ...
            <label for="chk_dateto">تاریخ درج نمودار تا : </label>
            <div class="vertical_small"></div>
            ...
            <hr />
            <div class="vertical_small"></div>
            <input id="fillter-input" type="text" class="search-input" placeholder="جستجو در نمودارها..." value="" />
            <div class="vertical_small"></div>
            <hr />

            <div class="vertical_small"></div>
            <input class="check" type="radio" id="fchk_nogrp" checked="checked" name="2" />
            <label for="fchk_nogrp">نمودارهای عمومی</label>
            <div class="vertical_min"></div>

            <input class="check" type="radio" id="fchk_allitem" name="2" />
            <label for="fchk_allitem">همه نمودارهای گروه بندی شده</label>
            <div class="vertical_min"></div>

            <input class="check" type="radio" id="fchk_toGroup" name="2" />
            <label for="fchk_toGroup">نمودارهای قرارگرفته در گروه زیر:</label>
            <div class="vertical_small"></div>
    ...
    <div class="left-panel">
        <div class="group-list">
            <span id="lt" class="header-group mci-1b">لیست نمودارهای عمومی</span>
            <a id="deleteall-btn" class="delete-all" title="حذف همه ی نمودارها"></a>
            <div class="clear"></div>
